class ManageIQ::Providers::Openstack::Inventory::Parser::NetworkManager < ManageIQ::Providers::Openstack::Inventory::Parser
  ...
  def network_ports
    collector.network_ports.each do |np|
      ...
      network_port.admin_state_up = np.admin_state_up unless np.admin_state_up.nil?
  ...
  def network_routers
    collector.network_routers.each do |nr|
      ...
      network_router.admin_state_up = nr.admin_state_up unless nr.admin_state_up.nil?
